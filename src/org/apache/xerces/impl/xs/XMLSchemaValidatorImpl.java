 ...
 * @version $Id$
 */
public class XMLSchemaValidatorImpl extends XMLSchemaValidator implements XMLComponent, XMLDocumentFilter, RevalidationHandler {
    ...
    */
    ...
    public void reset(XMLComponentManager componentManager) throws XMLConfigurationException {
        ...
        if (fDoValidation) {
            try {
                fDoValidation = componentManager.getFeature(XMLSchemaValidatorImpl.SCHEMA_VALIDATION);
            } catch (XMLConfigurationException e) {
            }
        }
    ...
    Object elementLocallyValidType(QName element, Object textContent) {
        ...
        if (fCurrentType.getTypeCategory() == XSTypeDefinition.SIMPLE_TYPE) {
            ...
            if (fSubElement) {
                reportSchemaError("cvc-type.3.1.2", new Object[] { element.rawname, XS11TypeHelper.getSchemaTypeName(fCurrentType) });
            }            
            else if (!fNil) {
