 ...
 * @version $Id: RedefineTests.java 1867202 2019-09-20 05:32:44Z mukulg $
 */
public class RedefineTests extends XercesAbstractTestCase {
	...
	public void testXSRedefine4() {
		...
		try {
            ...
            List expectedMsgList = new ArrayList();
            FailureMesgFragments mesgFragments = new FailureMesgFragments();
            mesgFragments.setMessageFragment("cvc-assertion: Assertion evaluation ('ns0:y mod 2 = 0') for element 'x' on schema type 'T1' did not succeed");
            expectedMsgList.add(mesgFragments);           
            assertTrue(areErrorMessagesConsistent(expectedMsgList));
		} catch(Exception ex) {
		   ex.printStackTrace();
	...
	public void testXSRedefine6() {
		...
		try {
            ...
            List expectedMsgList = new ArrayList();
            FailureMesgFragments mesgFragments = new FailureMesgFragments();
            mesgFragments.setMessageFragment("cvc-assertion: Assertion evaluation ('y mod 2 = 0') for element 'x' on schema type 'T1' did not succeed");
            expectedMsgList.add(mesgFragments);           
            assertTrue(areErrorMessagesConsistent(expectedMsgList));
		} catch(Exception ex) {
		   ex.printStackTrace();
